        ...
        <div className="relative z-10 max-w-xl mx-auto text-center">
          <div className="space-y-3">
            ...
            <p className="text-blue-100 leading-relaxed">
              Stay informed about admissions, events and academic updates from
              Indo Global Colleges. Join our newsletter today.
            </p>
          </div>
          <div className="mt-6">
            <form
            ...
            >
              ...
              />
              <button className="p-2 px-3 rounded-lg font-medium text-white bg-secondary-color hover:bg-blue-500 active:bg-blue-700 duration-150 outline-none shadow-md focus:shadow-none sm:px-4">
                Subscribe
              </button>
            </form>
